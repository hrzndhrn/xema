defmodule JsonSchemaTestSuite.Draft4.Optional.Bignum do
  use ExUnit.Case
  ...
  describe "float comparison with high precision" do
    setup do
      %{
        schema:
          Xema.from_json_schema(%{"exclusiveMaximum" => true, "maximum" => 9.727837981879871e26})
      }
    end
  ...
  describe "float comparison with high precision on negative numbers" do
    setup do
      %{
        schema:
          Xema.from_json_schema(%{"exclusiveMinimum" => true, "minimum" => -9.727837981879871e26})
      }
    end
