defmodule Suite.Draft4.Optional.FormatTest do
  use ExUnit.Case, async: true

  import Xema, only: [is_valid?: 2]

  describe "validation of date_time strings" do
    setup do
      %{schema: Xema.new(:any)}
    end
  ...
  describe "validation of _uRIs" do
    setup do
      %{schema: Xema.new(:any)}
    end
  ...
  describe "validation of e_mail addresses" do
    setup do
      %{schema: Xema.new(:any)}
    end
  ...
  describe "validation of _iP addresses" do
    setup do
      %{schema: Xema.new(:any)}
    end
  ...
  describe "validation of _iPv6 addresses" do
    setup do
      %{schema: Xema.new(:any)}
    end
